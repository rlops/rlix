...
- M11.2: dual-pipeline (Gate 4 + admission_epoch + multi-pipeline cleanup safety + graceful drain vs hard ray.kill)
...
### Gate 4 (M11.2 milestone — NOT M11.1 MVP gate): 双 MILES pipeline 调度

**M11.1 first build 不阻塞 Gate 4**. M11.2 multi-pipeline milestone 加回, 与
